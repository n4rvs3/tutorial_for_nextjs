...
基本はREADME.mdを参照しつつ、実際に手元で環境を作成・動作確認をしてください。

また、ディレクトリ内にある他ディレクトリはREADMEで紹介しているサンプルの完成形となります。

もし何か作業に詰まってしまった場合は対応するディレクトリを参照してください！
